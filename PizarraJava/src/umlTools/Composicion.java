...
/**
 * Herramienta para crear conexiones de composicion en uml.
            ...
            public void mouseDragged(MouseEvent e) { 
                if(estado == true){
                    if(e.getModifiersEx() == 1024){
                        ...
                        pizarraActual.g.fillPolygon(romboX, romboY, 4);
            ...
            @Override
                ...
                if(estado == true) {
                    if(e.getModifiersEx() == 0){
                        ...
                        pizarraActual.romboComposicion.add(rombo);
                        pizarraActual.repaint();
                    }
                }
            }   
